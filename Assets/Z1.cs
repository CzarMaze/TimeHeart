...
public class Z1 : Story {
	...
	void LateUpdate(){
		if(Input.GetKeyUp(KeyCode.Space)&&x){
			x=false;
			if(menu.taskexist("main","L")){//-------------"main"=>主線	"123456"=>編號123456 目標提示確認
				menu.deltask("main","L");//-------------"main"=>主線	"123456"=>編號123456 刪除目標提示
				meet("A","LA");//----------------------當擁有符合上述的目標提示 此對話改為另一個對話
