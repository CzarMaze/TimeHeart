...
public class testhito : MonoBehaviour {
	...
	void OnCollisionEnter2D(Collision2D other){
		menu.itemSave.gift=menu.Addnewitems(menu.itemSave,itemUI,"itemList","itemitem","人之初",2);
		menu.itemSave.gift=menu.Addnewitems(menu.itemSave,itemUI,"itemList","itemitem","人之初1",2);
